...
('苹果', 'https://example.com/apple-logo.png', 'Apple Inc.', 1),
('三星', 'https://example.com/samsung-logo.png', 'Samsung Electronics', 1),
('华为', 'https://example.com/huawei-logo.png', 'Huawei Technologies', 1);
...
SELECT COUNT(*) as product_count FROM products WHERE deleted = 0;
SELECT COUNT(*) as order_count FROM orders WHERE deleted = 0;